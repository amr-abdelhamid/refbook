...
{icon:bookmark}
B> *The question is: If you start from scratch, what makes you confident that you'll not hit the same wall again?*
...
{icon:bookmark}
B> *Managers will not sponsor an activity which they cannot track or control.*
...
{icon:bookmark}
B> *Disclaimer: Most of the information in this book is simple, and probably this is why it is very effective!*
